"""
Django settings for ssvmt_project project.
...
SECRET_KEY = 'django-insecure-zqrlm30ns*(q72hi)k6itkio-osjtc7ijzip&3n!=jr!fuct-2'
...
ROOT_URLCONF = 'ssvmt_project.urls'
...
WSGI_APPLICATION = 'ssvmt_project.wsgi.application'
...
# Cloudinary Configurations for media files persistence
CLOUDINARY_STORAGE = {
...
# Use Cloudinary for media files if configuration is present, fallback to local storage
